...
function mgf( t, options ) {
	...
	if ( isTypedArrayLike( t ) ) {
		...
		return mgf6( out, t, opts.sigma );
	}
	if ( isArrayLike( t ) ) {
		// Handle deepset first...
		if ( opts.path ) {
			opts.sep = opts.sep || '.';
			return mgf4( t, opts.sigma, opts.path, opts.sep );
		}
		...
		if ( opts.accessor ) {
			return mgf3( out, t, opts.sigma, opts.accessor );
		}
		return mgf2( out, t, opts.sigma );
	}
	return NaN;
} // end FUNCTION mgf()
